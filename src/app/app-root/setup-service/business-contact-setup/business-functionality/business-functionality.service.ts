...
postFunctionality(data:any):Observable<any>{
  return this.http.post<any>(this.root.getContactUrl()+'businesspartnersubcategoryapi/masters/cm001', JSON.stringify(data),this.root.getHeadersnode())
     .pipe(
...
getFunctionality(): Observable<any> {
  return this.http.get(this.root.getContactUrl()+'businesspartnersubcategoryapi/masters/cm001',this.root.getHeadersnode());
}
//put
...
deleteFunctionality(data:any):Observable<any>{
  return this.http.delete<any>(this.root.getContactUrl()+'businesspartnersubcategoryapi/masters/cm001/'+data.id,this.root.getHeadersnode())
    .pipe(map((res: any) => {
      return res;
    }));
}

...
export class CreateSubtaskComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    @Inject(MAT_DIALOG_DATA) private data: SubTask | any) {
  ...
  ngOnInit() {
    ...
    this.subTaskForm = this.fb.group({
      ...
      subDepartmentId: [],
      subtaskInitiationOn: new FormControl(this.datePipe.transform(new Date(), 'dd/MM/yyyy, hh:mm a')),
      estimatedDate: [],
      completedDate: [],
      completedTime: [],
      subtaskTargetDate: [],
      ...
      parentCategory: [],
      taskId: sessionStorage.getItem('rootId'),
    })
  ...
  updateTask() {
    ...
    this.data.partnerId = this.subTaskForm.value.partnerId;
